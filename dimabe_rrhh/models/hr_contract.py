...
class HrContract(models.Model):
    ...
    supplementary_insurance_id = fields.Many2one('custom.data', domain=['data_type_id', '=', 4])
    ...
    currency_supplementary_insurance_id = fields.Many2one('res.currency', 'Moneda', domain=[('id', 'in', (171, 173))])
