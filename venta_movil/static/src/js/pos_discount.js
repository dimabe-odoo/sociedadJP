    ...
    odoo.define('point_of_sale.models', function (require) {
        ...
        exports.PosModel = Backbone.Model.extend({
            initialize: function (session, attributes) {
                ...
                this.barcode_reader = new BarcodeReader({
                    'pos': this,
                    proxy: this.proxy
                });
            ...
            models: [{
                ...
                domain: function (self) {
                    return [
                        ['company_ids', 'in', self.config.company_id[0]], '|', ['groups_id', '=', self.config.group_pos_manager_id[0]],
                ...
                domain: function (self) {
                    return self.config.limit_categories && self.config.iface_available_categ_ids.length ? [
                ...
                domain: function (self) {
                    var domain = ['&', '&', ['sale_ok', '=', true],
                        ['available_in_pos', '=', true], '|', ['company_id', '=', self.config.company_id[0]],
                        ['company_id', '=', false]
                    ];
                ...
                domain: function (self) {
                    return [
                        ['id', 'in', self.config.fiscal_position_ids]
                    ];
                },
                ...
                loaded: function (self) {
                    var barcode_parser = new BarcodeParser({
                        'nomenclature_id': self.config.barcode_nomenclature_id
                    });
        ...
        exports.Orderline = Backbone.Model.extend({
            ...
            init_from_JSON: function (json) {
                ...
                for (var i = 0; i < pack_lot_lines.length; i++) {
                    ...
                    var pack_lot_line = new exports.Packlotline({}, {
                        'json': _.extend(packlotline, {
                            'order_line': this
                        })
                    });
            ...
            compute_lot_lines: function () {
                ...
                if (lots_required > lines) {
                    for (var i = 0; i < lots_required - lines; i++) {
                        pack_lot_lines.add(new exports.Packlotline({}, {
                            'order_line': this
                        }));
                    }
                }
            ...
            export_as_JSON: function () {
                ...
                return {
                    ...
                    tax_ids: [
                        [6, false, _.map(this.get_applicable_taxes(), function (tax) {
                            return tax.id;
                        })]
                    ],
                    id: this.id,
        ...
        exports.Packlotline = Backbone.Model.extend({
            ...
            add: function () {
                ...
                var new_lot_model = new exports.Packlotline({}, {
                    'order_line': this.order_line
                });
                this.collection.add(new_lot_model, {
                    at: index + 1
                });
        ...
        exports.Order = Backbone.Model.extend({
            initialize: function (attributes, options) {
                ...
                this.orderlines.on('change', function () {
                    this.save_to_db("orderline:change");
                }, this);
                this.orderlines.on('add', function () {
                    this.save_to_db("orderline:add");
                }, this);
                this.orderlines.on('remove', function () {
                    this.save_to_db("orderline:remove");
                }, this);
                this.paymentlines.on('change', function () {
                    this.save_to_db("paymentline:change");
                }, this);
                this.paymentlines.on('add', function () {
                    this.save_to_db("paymentline:add");
                }, this);
                this.paymentlines.on('remove', function () {
                    this.save_to_db("paymentline:rem");
                }, this);
            ...
            init_from_JSON: function (json) {
                ...
                for (var i = 0; i < orderlines.length; i++) {
                    ...
                    this.add_orderline(new exports.Orderline({}, {
                        pos: this.pos,
                        order: this,
                        json: orderline
                    }));
                ...
                for (var i = 0; i < paymentlines.length; i++) {
                    ...
                    var newpaymentline = new exports.Paymentline({}, {
                        pos: this.pos,
                        order: this,
                        json: paymentline
                    });
                                ...
                                if (order.pricelist) {
                                    ...
                                    order.pricelist.items.forEach(item => {
                                        if (item.product_tmpl_id[0] == element.id) {
                                            ...
                                            var el_str = QWeb.render('OrderWidget', {
                                                widget: this,
                                                order: order,
                                                orderlines: orderlines
                                            });
                                            ...
                                            this.el.querySelector('.summary .total > .value').textContent = this.format_currency(order.selected_orderline);
